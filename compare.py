...
EFFECTS = {
    ...
    "psar":               "trend  | parabolic stop-and-reverse, rides clean trends",
    "aroon":              "trend  | times trend changes via recent highs/lows",
    "dmi_cross":          "trend  | +DI/-DI cross, no strength gate (vs adx)",
    "trix":               "moment.| triple-smoothed momentum, low whipsaw",
    "kama_trend":         "trend  | adaptive MA, speeds up/slows to noise",
    "williams_r":         "revert | %R oscillator oversold bounces",
    "obv_trend":          "VOLUME | on-balance volume trend confirmation",
    "vwma_trend":         "VOLUME | volume-weighted MA crossover",
    "mfi":                "VOLUME | money-flow (volume-weighted RSI) reversion",
    "roc_accel":          "moment.| momentum acceleration (2nd derivative)",
